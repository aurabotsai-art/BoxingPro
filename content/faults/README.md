...
**Status: v0 seed (10 faults).** Target ~40 for MVP (docs/11 Phase 1). Every fault must name: detector expression, severity model, root causes with discriminators, explanation ("why this loses fights"), and fixes-by-cause referencing real drill IDs in `content/drills/`.
